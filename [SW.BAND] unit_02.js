...
function t3(min = 0, max = 300) {
    const out3 = document.querySelector('.out-3');
    let random = Math.floor(min + Math.random() * (max + 1 - min))
    out3.textContent = random
}
...
// Task 7
// Давайте напишем функцию t7, которая выводит переданный ей массив (как аргумент arr) в блок (переданный как аргумент block) 
// через пробел. Задайте аргумент arr равный по умолчанию пустому массиву.
